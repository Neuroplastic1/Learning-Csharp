...
namespace ChooseYourOwnAdventure
{
  class Program
  {
      static void Main(string[] args)
    {
      ...
      Console.WriteLine("Incase you changed your mind...try knocking/opening the door or type anything else to exit game...");
      }
      ...
      if (doorChoice == "KNOCK") 
      {
       ...
       else
       {
         ...
         Console.WriteLine("THE END.");
         Console.WriteLine("Correct answer was \"NOTHING!\" ");
       }
      }
